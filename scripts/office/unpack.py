"""Unpack Office files (PPTX, XLSX) for editing.
...
def unpack(
    ...
    if suffix not in {".pptx", ".xlsx"}:
        return None, f"Error: {input_file} must be a .pptx or .xlsx file"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Unpack an Office file (PPTX, XLSX) for editing"
    )
